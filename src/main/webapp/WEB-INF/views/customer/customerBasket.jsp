			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container-fluid">
					<c:choose>
						...
						<c:when test="${ !empty bpList }">
							<form action="customerBuyItem.cu" method="POST">
								<ul id="ul_area">
									<li id="item_head">
									...
									<c:forEach items="${ bpList }" var="bpl">
										<li>
											<div class="item">
												...
												<div class="item_img">
													<img src="resources/business/images/${ bpl.product.productThumbNail }" />
												</div>
												<div class="item_info">
							...
							<div id="item_total_info">
								...
								<div id="item_btn">
									<button type="button" id="item_orderBtn">주문하기</button>
								</div>
							</div>
						</c:when>
					</c:choose>
