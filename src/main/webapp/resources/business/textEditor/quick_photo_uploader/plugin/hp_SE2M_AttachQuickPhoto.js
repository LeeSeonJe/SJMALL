...
//		var sTag = '<img style="max-width:1024px; max-height:768px;" src="{=sOriginalImageURL}" title="{=sName}" >';
		var sTag = '<br><img style="max-width:800px; max-height:600px;" src="{=sOriginalImageURL}">';
